...
- [Current build-system handoff](current-status.md) — latest verified status, constraints, open work, and the exact
...
- [Unity module plan](unity.md)

The repository-level [`README.md`](../README.md) remains the public project entry point. Agent instructions remain in [`AGENTS.md`](../AGENTS.md).
